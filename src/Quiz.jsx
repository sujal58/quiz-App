...
function Quiz({category, setActive}) {
  ...
  return (
      <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 h-screen text-white ${textMode} ${themeMode} pt-10`}>
      {questionNo < 10 ? (
          <div className={`flex content-center flex-col items-center justify-center font-sansserif ${textMode}`}>
                    ...
                    <br />
                  <div className={`progress-container h-3 ${themeMode === "bg-white" ? "bg-white" : "bg-slate-800"} w-72 md:w-96 2xl:w-7/12 rounded-xl mb-2 md:mt-10`}>
